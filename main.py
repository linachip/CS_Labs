...
def openFile():
    ...
    if extension == 'audit':
        ...
        custom_item = {
            'REGISTRY_SETTING': {'type': [], 'description': [], 'value_type': [], 'value_data': [], 'reg_key': [],
                                 'reg_item': [], 'reg_option': [], 'info': []},
            'AUDIT_POWERSHELL': {'type': [], 'description': [], 'value_type': [], 'value_data': [],
                                 'powershell_args': [],
                                 'only_show_cmd_output': [], 'check_type': [], 'severity': [], 'appcmd_list': [],
                                 'appcmd_filter': [], 'appcmd_filter_value': []},
            'PASSWORD_POLICY': {'type': [], 'description': [], 'value_type': [], 'value_data': [],
                                'check_type': [],
                                'password_policy': []},
            'LOCKOUT_POLICY': {'type': [], 'description': [], 'value_type': [], 'value_data': [],
                               'check_type': [],
                               'lockout_policy': []},
            'USER_RIGHTS_POLICY': {'type': [], 'description': [], 'value_type': [], 'value_data': [],
                                   'check_type': [],
                                   'right_type': []},
            'CHECK_ACCOUNT': {'type': [], 'description': [], 'value_type': [], 'value_data': [], 'check_type': [],
                              'account_type': []},
            'BANNER_CHECK': {'type': [], 'description': [], 'value_type': [], 'value_data': [], 'reg_key': [],
                             'reg_item': [], 'is_substring': []},
            'AUDIT_POLICY_SUBCATEGORY': {'type': [], 'description': [], 'value_type': [], 'value_data': [],
                                         'check_type': [],
                                         'audit_policy_policy': []},
            'REG_CHECK': {'type': [], 'description': [], 'value_type': [], 'value_data': [],
                          'reg_key': [], 'reg_item': [], 'key_item': []},
            'ANONYMOUS_SID_SETTING': {'type': [], 'description': [], 'value_type': [], 'value_data': [],
                                      'check_type': []}}
